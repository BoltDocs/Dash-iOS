...
@interface DHDBSearchController : NSObject <UISearchControllerDelegate, UISearchResultsUpdating, UITableViewDataSource, UITableViewDelegate, DHDBSearcherDelegate, DHSearchResultsControllerDelegate>
